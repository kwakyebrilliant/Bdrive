    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        ...
        <a className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-blue-300 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring" href="#nothing">
          ...
          <h2 className="mt-2 font-bold">Photo</h2>
        ...
        <a className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-green-300 hover:ring-1 hover:ring-green-300 focus:outline-none focus:ring" href="#nothing">
          <span className="inline-block rounded-lg bg-gray-50 p-3">
        ...
        <a className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-green-300 hover:ring-1 hover:ring-green-300 focus:outline-none focus:ring" href="#noting">
          <span className="inline-block rounded-lg bg-gray-50 p-3">
          <DocumentIcon className='h-6 w-6' />
          </span>
        ...
        <a className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-red-300 hover:ring-1 hover:ring-red-300 focus:outline-none focus:ring" href="#nothing">
          ...
          <h2 className="mt-2 font-bold">Excel</h2>
        ...
        <a className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-red-300 hover:ring-1 hover:ring-red-300 focus:outline-none focus:ring" href="#nothing">
          ...
          <h2 className="mt-2 font-bold">Access</h2>
        ...
        <a className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-red-300 hover:ring-1 hover:ring-red-300 focus:outline-none focus:ring" href="#nothing">
          ...
          <h2 className="mt-2 font-bold">Zipped files</h2>
